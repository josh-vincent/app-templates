          ...
          <View>
            <View
              ...
              <Pressable
                ...
                <Icon name="Plus" size={14} color="#0d1014" />
                <Text style={{ color: '#0d1014', fontWeight: '800', fontSize: 13 }}>New bet</Text>
              </Pressable>
            </View>
          </View>
        }
  ...
  return (
    <Pressable
      ...
      <View
        ...
        <Icon name={activity.icon as any} size={18} color={colors.text} />
      </View>

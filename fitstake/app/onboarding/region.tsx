    ...
    <View style={{ flex: 1, backgroundColor: IRON, paddingTop: insets.top }}>
      <View style={{ flex: 1, paddingHorizontal: PAGE_X, justifyContent: 'space-between' }}>
        ...
        <View>
          ...
          {/* Privacy promise as a glanceable lime chip — the actual reason
              a paranoid user is willing to tap "Use my location". */}
          <View
            style={{
              ...
              borderRadius: 999,
              backgroundColor: LIME + '1f',
            }}>
            <View style={{ width: 6, height: 6, borderRadius: 3, backgroundColor: LIME }} />
            <Text style={{ color: LIME, fontSize: 12, fontWeight: '700' }}>
              Country only · never your address
            </Text>
          </View>
          <Text
            style={{
        ...
        <View style={{ paddingBottom: 12 }}>
          ...
          <Pressable
            ...
            style={{
              ...
              borderRadius: 14,
              borderWidth: 1,
              borderColor: 'rgba(247,244,239,0.24)',
              alignItems: 'center',
              justifyContent: 'center',
            }}>
            <Text style={{ color: BONE, opacity: 0.8, fontWeight: '700', fontSize: 15 }}>
              Skip for now
            </Text>
          </Pressable>
        </View>

...
import type { FitStakeMoment } from '@/lib/fitstakeMoments';
import { IRON } from '@jv/tokens';
...
type Props = {
  ...
  moment: FitStakeMoment;
  onPrimaryPress?: () => void;
};

export default function FitStakeMomentCard({ colors, moment, onPrimaryPress }: Props) {

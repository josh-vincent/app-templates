...
> **This is the product doc for the HealthPulse example app that ships with
> the template** — not your project's product doc. When the template's
> rename script runs, every occurrence of `HealthPulse` in this file is
...
### Users
HealthPulse users are people who already track activity (steps, runs, rides,

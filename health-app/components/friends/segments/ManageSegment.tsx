...
import { SCENARIO_MASCOTS } from '@/lib/healthpulseImages';
...
export function ManageSegment() {
  ...
  async function onInvite() {
    ...
    const link = handle ? `healthpulse://join/${handle}` : 'healthpulse://join';
    const intro = handle
      ? `I'm @${handle} on HealthPulse. Bet me on workouts and steps:`
      : 'I started using HealthPulse. We can bet on workouts and steps. Get the app:';
    try {

...
> **This is the product doc for the FitStake example app that ships with
> the template** — not your project's product doc. When the template's
> rename script runs, every occurrence of `FitStake` in this file is
...
### Users
FitStake users are people who already track activity (steps, runs, rides,

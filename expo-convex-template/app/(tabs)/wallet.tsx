...
const WALLET_LEVELS = [
  {
    title: 'Reset window',
    eyebrow: 'LEVEL 1 · RESET',
    sub: 'Losses are leading. Keep the next stake small and win one clean.',
    tone: EMBER,
  },
  {
    title: 'Comeback line',
    eyebrow: 'LEVEL 2 · COMEBACK',
    sub: 'The hole is real, but one disciplined bet starts closing it.',
    tone: EMBER,
  },
  {
    title: 'Damage control',
    eyebrow: 'LEVEL 3 · STABILIZE',
    sub: 'You are slowing the bleed. Pick goals you can actually settle.',
    tone: EMBER,
  },
  {
    title: 'Back in range',
    eyebrow: 'LEVEL 4 · IN RANGE',
    sub: 'A couple of finished stakes puts you back above water.',
    tone: GOLD,
  },
  {
    title: 'Even money',
    eyebrow: 'LEVEL 5 · EVEN',
    sub: 'Wins and forfeits are balanced. The next result moves the story.',
    tone: GOLD,
  },
  {
    title: 'Green edge',
    eyebrow: 'LEVEL 6 · EDGE',
    sub: 'You are net positive. Keep the stake size boring and the results loud.',
    tone: LIME,
  },
  {
    title: 'Heat check',
    eyebrow: 'LEVEL 7 · HEAT',
    sub: 'The wallet is moving your way. Do not give it back on a loose line.',
    tone: LIME,
  },
  {
    title: 'Dominating',
    eyebrow: 'LEVEL 8 · DOMINATING',
    sub: 'Wins are doing the talking. Keep taking bets you can settle.',
    tone: LIME,
  },
  {
    title: 'Championship pace',
    eyebrow: 'LEVEL 9 · CHAMPIONSHIP',
    sub: 'This is a serious run. Stay sharp, make friends chase your line.',
    tone: GOLD,
  },
  {
    title: 'Top of the board',
    eyebrow: 'LEVEL 10 · TOP BOARD',
    sub: 'You are clearing goals and stacking outcomes. That is the standard.',
    tone: GOLD,
  },
] as const;
      ...
      <FlatList
        ...
        ListHeaderComponent={
          <View>
            ...
            {/* Balance hero — paired numbers, no card chrome */}
            <View style={{ marginTop: 14 }}>
              ...
              <Text style={{ ...EYEBROW, color: walletLevel.tone, marginTop: 4 }}>
                {walletLevel.eyebrow}
              </Text>
              <Text
                style={{

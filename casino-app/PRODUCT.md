...
> **This is the product doc for the LuckyChips example app that ships with
> the template** — not your project's product doc. When the template's
> rename script runs, every occurrence of `LuckyChips` in this file is
...
### Users
LuckyChips users are people who already track activity (steps, runs, rides,
